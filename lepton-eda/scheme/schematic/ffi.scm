...
(define-module (schematic ffi)
  ...
  #:export (lepton_schematic_run
            ...
            *schematic_window_notify_page_callback
            ...
            schematic_window_get_net_selection_state
...
(define-lff schematic_window_get_net_selection_state int '(*))
...
(define-lff schematic_autonumber_get_autotext_scope_skip int '(*))
